...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2024 a las 11:17:28
...
(0, 's', 'd', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'f', '2024-05-23', 'mayorista'),
(1111, 'a', 'a', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'a', '2024-05-23', 'mayorista'),
(1475, 'a', 'a', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'a', '2024-05-23', 'mayorista'),
(3847, 'Carlos Walter', 'Montaño Laura', 'carlos', '123456789', 'Illampu', '2024-05-20', 'minorista'),
(11111, 'a', 'a', 'a', 'a', 'a', '2024-05-23', 'mayorista'),
(12313, 'asdasd', 'asdasdsd', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'aaaaaa', '2024-05-23', 'mayorista'),
(12345, 'Luis', 'Chino', 'luis', '123456789', 'X', '2024-05-20', 'mayorista'),
(33333, 'a', 'a', 'a', 'a', 'a', '2024-05-23', 'mayorista'),
(111111, 'a', 'a', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'a', '2024-05-23', 'mayorista'),
(2222222, 'a', 'a', 'a', 'a', 'a', '2024-05-23', 'mayorista'),
(4444444, 'a', 'a', 'a', 'a', 'a', '2024-05-23', 'mayorista'),
(11111111, 'Preuba1', 'Preuba1', 'Preuba1', '160305Encinas*', 'Preuba1', '2024-05-23', 'mayorista'),
(12606949, 'Ailyn', 'Gutierrez', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'Alto Obrajes, Sector A', '2024-05-23', 'mayorista'),
(16404909, 'Ailyn', 'Gutierrez', 'ailyn encinas', '160305Encinas', 'Alto Obrajes, Sector A', '2024-05-20', 'mayorista'),
(33333342, 'Ailyn', 'Gutierrez', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'Alto Obrajes, Sector A', '2024-05-23', 'mayorista'),
(1111111111, 'q', 'q', 'a', 'a', 'q', '2024-05-23', 'mayorista'),
(2147483647, 'Ailyn', 'Gutierrez', 'root_Encinas', '$2y$10$c2zjZukzXMMEYCYh.c7muuGEbKlQ3kz3ffUu50pFLXpGmj/nbhrGO', 'Alto Obrajes, Sector A', '2024-05-23', 'mayorista');
...
(123456, 'Jhillmar Hugo', 'Encinas Herrera', 'JE', '12', '2005-03-16', 'jhillmar@gmail.com', 73079452, 'Alto Obrajes', 'propietario'),
...
--
ALTER TABLE `empleado`
  MODIFY `id_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46548;
